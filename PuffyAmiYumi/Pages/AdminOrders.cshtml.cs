...
namespace PuffyAmiYumi.Pages
{
    ...
    {
        //bring in orders
        //dependency injection for order interface
        //get x amount of orders

        //front end goes through for loop

            //create form for productcontroller (CRUD operations)
        ...
        public class ProfileModel : PageModel
        {
            ...
            private List<Order> GetOrders { get; set; }
