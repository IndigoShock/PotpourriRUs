...
namespace PuffyAmiYumi.Migrations
{
    ...
    [Migration("20180713193845_editIMG2")]
    partial class editIMG2
    {
            ...
            modelBuilder.Entity("PuffyAmiYumi.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new { ID = 1, ImageURL = "~/wwwroot/asset/Geranium.jpg", Price = 11.99m, ProductName = "Karma-Patchouli-Potpourri", Stock = 100 },
